...
- Scaling-phase capture note:
  ...
  - current representative stable metrics for that experimental baseline: `full 38.7107`, `left 60.4661`, `right 42.2332`, `top 41.6697`, `bottom 37.0707`, `file2_new 20.1640`
  ...
  - the biggest recent improvement came from source-domain setup, not another VI kernel tweak; if future tuning stalls again, inspect the source mapping fed into `scale_stage()` before spending many more cycles on shader kernel variants
- Save-state warning:
