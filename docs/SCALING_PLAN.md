...
- Latest Paper Mario oracle comparison for the current experimental path:
  - representative stable run: `full 46.7833`, `left 64.1704`, `right 46.7738`, `top 45.6523`, `bottom 57.1673`, `file2_new 20.7021`
