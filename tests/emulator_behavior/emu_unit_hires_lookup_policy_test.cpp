...
static void test_strict_lookup_gate_contract()
{
	...
	const auto narrow_32x32_policy = resolve_hires_lookup_mode_policy(6);
	const auto narrow_16x16_policy = resolve_hires_lookup_mode_policy(7);
	...
	const auto narrow_pending_32x16_policy = resolve_hires_lookup_mode_policy(12);
	const auto narrow_alias_32x16_policy = resolve_hires_lookup_mode_policy(13);
	const auto narrow_32x32_pending_32x16_policy = resolve_hires_lookup_mode_policy(14);
	const auto narrow_32x32_alias_32x16_policy = resolve_hires_lookup_mode_policy(15);
	const auto narrow_phase_16x16_pending_32x16_policy = resolve_hires_lookup_mode_policy(16);
	const auto narrow_phase_16x16_alias_32x16_policy = resolve_hires_lookup_mode_policy(17);
	...
	const auto pattern_32x16_policy = resolve_hires_reinterpretation_birth_pattern_policy(narrow_32x16_policy);
	const auto pattern_32x32_16x16_policy = resolve_hires_reinterpretation_birth_pattern_policy(narrow_32x32_16x16_policy);
	const auto pattern_32x32_32x16_policy = resolve_hires_reinterpretation_birth_pattern_policy(narrow_32x32_32x16_policy);
	...
	check(!hires_lookup_strict_enabled(5), "lookup mode 5 should not force strict provider matching");
	...
	check(!hires_lookup_owner_only_enabled(5), "lookup mode 5 should not be owner-only");
	...
	check(!hires_lookup_no_reinterpretation_enabled(5), "lookup mode 5 should not be the no-reinterp mode");
	...
	check(!hires_lookup_owner_reinterpretation_enabled(5), "lookup mode 5 should not be owner-reinterp");
	check(!hires_lookup_narrow_reinterpretation_enabled(0), "lookup mode 0 should not be narrow-reinterp");
	check(!hires_lookup_narrow_reinterpretation_enabled(1), "lookup mode 1 should not be narrow-reinterp");
	check(!hires_lookup_narrow_reinterpretation_enabled(2), "lookup mode 2 should not be narrow-reinterp");
	check(!hires_lookup_narrow_reinterpretation_enabled(3), "lookup mode 3 should not be narrow-reinterp");
	check(!hires_lookup_narrow_reinterpretation_enabled(4), "lookup mode 4 should not be narrow-reinterp");
	check(hires_lookup_narrow_reinterpretation_enabled(5), "lookup mode 5 should be narrow-reinterp");
	check(!hires_lookup_narrow_reinterpretation_enabled(6), "lookup mode 6 should not be the combined narrow-reinterp mode");
	check(!hires_lookup_narrow_reinterpretation_enabled(7), "lookup mode 7 should not be the combined narrow-reinterp mode");
	...
	check(!hires_lookup_narrow_reinterpretation_enabled(12), "lookup mode 12 should not be the combined narrow-reinterp mode");
	check(!hires_lookup_narrow_reinterpretation_enabled(13), "lookup mode 13 should not be the combined narrow-reinterp mode");
	check(!hires_lookup_narrow_reinterpretation_enabled(14), "lookup mode 14 should not be the combined narrow-reinterp mode");
	check(!hires_lookup_narrow_reinterpretation_enabled(15), "lookup mode 15 should not be the combined narrow-reinterp mode");
	check(!hires_lookup_narrow_reinterpretation_enabled(16), "lookup mode 16 should not be the combined narrow-reinterp mode");
	check(!hires_lookup_narrow_reinterpretation_enabled(17), "lookup mode 17 should not be the combined narrow-reinterp mode");
	...
	check(hires_lookup_narrow_reinterpretation_pending_32x16_enabled(12), "lookup mode 12 should be narrow-32x16-pending");
	check(hires_lookup_narrow_reinterpretation_alias_32x16_enabled(13), "lookup mode 13 should be narrow-32x16-alias");
	check(hires_lookup_narrow_reinterpretation_32x32_pending_32x16_enabled(14), "lookup mode 14 should be narrow-32x32-pending-32x16");
	check(hires_lookup_narrow_reinterpretation_32x32_alias_32x16_enabled(15), "lookup mode 15 should be narrow-32x32-alias-32x16");
	check(hires_lookup_narrow_reinterpretation_phase_16x16_pending_32x16_enabled(16), "lookup mode 16 should be narrow-reinterp-phase-16x16-pending-32x16");
	check(hires_lookup_narrow_reinterpretation_phase_16x16_alias_32x16_enabled(17), "lookup mode 17 should be narrow-reinterp-phase-16x16-alias-32x16");
	...
	check(hires_lookup_fallbacks_enabled(5), "lookup mode 5 should keep reinterpretation fallbacks enabled");
	check(hires_lookup_fallbacks_enabled(6), "lookup mode 6 should keep reinterpretation fallbacks enabled");
	check(hires_lookup_fallbacks_enabled(7), "lookup mode 7 should keep reinterpretation fallbacks enabled");
	...
	check(hires_lookup_fallbacks_enabled(12), "lookup mode 12 should keep reinterpretation fallbacks enabled");
	check(hires_lookup_fallbacks_enabled(13), "lookup mode 13 should keep reinterpretation fallbacks enabled");
	check(hires_lookup_fallbacks_enabled(14), "lookup mode 14 should keep reinterpretation fallbacks enabled");
	check(hires_lookup_fallbacks_enabled(15), "lookup mode 15 should keep reinterpretation fallbacks enabled");
	check(hires_lookup_fallbacks_enabled(16), "lookup mode 16 should keep reinterpretation fallbacks enabled");
	check(hires_lookup_fallbacks_enabled(17), "lookup mode 17 should keep reinterpretation fallbacks enabled");
	...
	check(hires_lookup_block_reinterpretation_enabled(5), "lookup mode 5 should allow block reinterpretation");
	check(hires_lookup_block_reinterpretation_enabled(6), "lookup mode 6 should allow block reinterpretation");
	check(hires_lookup_block_reinterpretation_enabled(7), "lookup mode 7 should allow block reinterpretation");
	...
	check(hires_lookup_block_reinterpretation_enabled(12), "lookup mode 12 should allow block reinterpretation");
	check(hires_lookup_block_reinterpretation_enabled(13), "lookup mode 13 should allow block reinterpretation");
	check(hires_lookup_block_reinterpretation_enabled(14), "lookup mode 14 should allow block reinterpretation");
	check(hires_lookup_block_reinterpretation_enabled(15), "lookup mode 15 should allow block reinterpretation");
	check(hires_lookup_block_reinterpretation_enabled(16), "lookup mode 16 should allow block reinterpretation");
	check(hires_lookup_block_reinterpretation_enabled(17), "lookup mode 17 should allow block reinterpretation");
	...
	check(hires_lookup_pending_block_retry_enabled(5), "lookup mode 5 should allow pending block retry");
	check(hires_lookup_pending_block_retry_enabled(6), "lookup mode 6 should allow pending block retry");
	check(hires_lookup_pending_block_retry_enabled(7), "lookup mode 7 should allow pending block retry");
	...
	check(hires_lookup_pending_block_retry_enabled(12), "lookup mode 12 should allow pending block retry");
	check(hires_lookup_pending_block_retry_enabled(13), "lookup mode 13 should allow pending block retry");
	check(hires_lookup_pending_block_retry_enabled(14), "lookup mode 14 should allow pending block retry");
	check(hires_lookup_pending_block_retry_enabled(15), "lookup mode 15 should allow pending block retry");
	check(hires_lookup_pending_block_retry_enabled(16), "lookup mode 16 should allow pending block retry");
	check(hires_lookup_pending_block_retry_enabled(17), "lookup mode 17 should allow pending block retry");
	...
	check(!should_try_hires_ci_low32_fallback(narrow_reinterp_policy), "narrow-reinterp lookup should reject CI low32 fallback");
	check(!should_try_hires_ci_low32_fallback(narrow_32x32_policy), "narrow-32x32 lookup should reject CI low32 fallback");
	check(!should_try_hires_ci_low32_fallback(narrow_16x16_policy), "narrow-16x16 lookup should reject CI low32 fallback");
	...
	check(!should_try_hires_ci_low32_fallback(narrow_pending_32x16_policy), "narrow-32x16-pending lookup should reject CI low32 fallback");
	check(!should_try_hires_ci_low32_fallback(narrow_alias_32x16_policy), "narrow-32x16-alias lookup should reject CI low32 fallback");
	check(!should_try_hires_ci_low32_fallback(narrow_32x32_pending_32x16_policy), "narrow-32x32-pending-32x16 lookup should reject CI low32 fallback");
	check(!should_try_hires_ci_low32_fallback(narrow_32x32_alias_32x16_policy), "narrow-32x32-alias-32x16 lookup should reject CI low32 fallback");
	check(!should_try_hires_ci_low32_fallback(narrow_phase_16x16_pending_32x16_policy), "narrow-reinterp-phase-16x16-pending-32x16 lookup should reject CI low32 fallback");
	check(!should_try_hires_ci_low32_fallback(narrow_phase_16x16_alias_32x16_policy), "narrow-reinterp-phase-16x16-alias-32x16 lookup should reject CI low32 fallback");
	...
	check(!should_try_hires_tile_mask_fallback(narrow_reinterp_policy, true),
	      "narrow-reinterp lookup should reject tile-mask fallback");
	check(!should_try_hires_tile_mask_fallback(narrow_32x32_policy, true),
	      "narrow-32x32 lookup should reject tile-mask fallback");
	check(!should_try_hires_tile_mask_fallback(narrow_16x16_policy, true),
	      "narrow-16x16 lookup should reject tile-mask fallback");
	check(!should_try_hires_tile_mask_fallback(narrow_32x16_policy, true),
	      "narrow-32x16 lookup should reject tile-mask fallback");
	check(!should_try_hires_tile_mask_fallback(narrow_32x32_16x16_policy, true),
	      "narrow-32x32-16x16 lookup should reject tile-mask fallback");
	check(!should_try_hires_tile_mask_fallback(narrow_32x32_32x16_policy, true),
	      "narrow-32x32-32x16 lookup should reject tile-mask fallback");
	...
	check(!should_try_hires_tile_stride_fallback(narrow_reinterp_policy, true),
	      "narrow-reinterp lookup should reject tile-stride fallback");
	check(!should_try_hires_tile_stride_fallback(narrow_32x32_policy, true),
	      "narrow-32x32 lookup should reject tile-stride fallback");
	check(!should_try_hires_tile_stride_fallback(narrow_16x16_policy, true),
	      "narrow-16x16 lookup should reject tile-stride fallback");
	check(!should_try_hires_tile_stride_fallback(narrow_32x16_policy, true),
	      "narrow-32x16 lookup should reject tile-stride fallback");
	check(!should_try_hires_tile_stride_fallback(narrow_32x32_16x16_policy, true),
	      "narrow-32x32-16x16 lookup should reject tile-stride fallback");
	check(!should_try_hires_tile_stride_fallback(narrow_32x32_32x16_policy, true),
	      "narrow-32x32-32x16 lookup should reject tile-stride fallback");
	...
	check(should_try_hires_block_tile_fallback(narrow_reinterp_policy, true),
	      "narrow-reinterp lookup should allow block-tile fallback");
	check(should_try_hires_block_tile_fallback(narrow_32x32_policy, true),
	      "narrow-32x32 lookup should allow block-tile fallback");
	check(should_try_hires_block_tile_fallback(narrow_16x16_policy, true),
	      "narrow-16x16 lookup should allow block-tile fallback");
	check(should_try_hires_block_tile_fallback(narrow_32x16_policy, true),
	      "narrow-32x16 lookup should allow block-tile fallback");
	check(should_try_hires_block_tile_fallback(narrow_32x32_16x16_policy, true),
	      "narrow-32x32-16x16 lookup should allow block-tile fallback");
	check(should_try_hires_block_tile_fallback(narrow_32x32_32x16_policy, true),
	      "narrow-32x32-32x16 lookup should allow block-tile fallback");
	...
	check(should_try_hires_block_shape_fallback(narrow_reinterp_policy, true),
	      "narrow-reinterp lookup should allow block-shape fallback");
	check(should_try_hires_block_shape_fallback(narrow_32x32_policy, true),
	      "narrow-32x32 lookup should allow block-shape fallback");
	check(should_try_hires_block_shape_fallback(narrow_16x16_policy, true),
	      "narrow-16x16 lookup should allow block-shape fallback");
	check(should_try_hires_block_shape_fallback(narrow_32x16_policy, true),
	      "narrow-32x16 lookup should allow block-shape fallback");
	check(should_try_hires_block_shape_fallback(narrow_32x32_16x16_policy, true),
	      "narrow-32x32-16x16 lookup should allow block-shape fallback");
	check(should_try_hires_block_shape_fallback(narrow_32x32_32x16_policy, true),
	      "narrow-32x32-32x16 lookup should allow block-shape fallback");
}
...
static void test_lookup_birth_family_contract()
{
	...
	check(should_accept_hires_reinterpretation_birth_family(narrow_reinterp_policy, same_owner),
	      "narrow-reinterp policy should allow same-format owner reinterpretation families");
	check(should_accept_hires_reinterpretation_birth_family(narrow_reinterp_policy, same_alias),
	      "narrow-reinterp family mask should accept same-format alias families");
	check(should_accept_hires_reinterpretation_birth_family(narrow_reinterp_policy, cross_owner),
	      "narrow-reinterp policy should allow cross-format owner reinterpretation families");
	check(should_accept_hires_reinterpretation_birth_family(narrow_reinterp_policy, cross_alias),
	      "narrow-reinterp family mask should accept cross-format alias families");
	check(should_accept_hires_reinterpretation_birth_pattern(narrow_reinterp_policy, same_owner),
	      "narrow-reinterp policy should allow the 32x32 same-format owner pattern");
	check(!should_accept_hires_reinterpretation_birth_pattern(narrow_reinterp_policy, same_alias),
	      "narrow-reinterp policy should reject same-format 4x32 alias patterns");
	check(should_accept_hires_reinterpretation_birth_pattern(narrow_reinterp_policy, cross_owner),
	      "narrow-reinterp policy should allow the 16x16 cross-format owner pattern");
	check(should_accept_hires_reinterpretation_birth_pattern(narrow_reinterp_policy, cross_alias),
	      "narrow-reinterp policy should allow the 32x16 cross-format alias pattern");

	const auto cross_owner_32x16 = make_hires_lookup_birth_signature(7, 0x202, 0, 0x02, 32, 16);
	check(should_accept_hires_reinterpretation_birth_pattern(narrow_reinterp_policy, cross_owner_32x16),
	      "narrow-reinterp policy should allow the 32x16 cross-format owner pattern");

	const auto same_alias_32x32 = make_hires_lookup_birth_signature(7, 0x300, 7, 0x300, 32, 32);
	check(should_accept_hires_reinterpretation_birth_pattern(narrow_reinterp_policy, same_alias_32x32),
	      "narrow-reinterp policy should allow the 32x32 same-format alias pattern");

	const auto cross_alias_16x16 = make_hires_lookup_birth_signature(7, 0x202, 7, 0x02, 16, 16);
	check(should_accept_hires_reinterpretation_birth_pattern(narrow_reinterp_policy, cross_alias_16x16),
	      "narrow-reinterp policy should allow the 16x16 cross-format alias pattern");

	const auto bad_cross_alias_8x16 = make_hires_lookup_birth_signature(7, 0x202, 7, 0x02, 8, 16);
	check(!should_accept_hires_reinterpretation_birth_pattern(narrow_reinterp_policy, bad_cross_alias_8x16),
	      "narrow-reinterp policy should reject cross-format 8x16 alias patterns");

	const auto bad_same_owner = make_hires_lookup_birth_signature(7, 0x204, 0, 0x204, 4, 32);
	check(!should_accept_hires_reinterpretation_birth_pattern(narrow_reinterp_policy, bad_same_owner),
	      "narrow-reinterp policy should reject 4x32 same-format owner patterns");
	...
	check(pattern_32x32_policy.pattern_count == 1u,
	      "narrow-32x32 policy should expose exactly one birth pattern");
	check(matches_hires_lookup_birth_pattern(same_owner, pattern_32x32_policy.patterns[0]),
	      "narrow-32x32 policy should match the 32x32 same-format case");
	check(pattern_16x16_policy.pattern_count == 1u,
	      "narrow-16x16 policy should expose exactly one birth pattern");
	check(matches_hires_lookup_birth_pattern(cross_owner, pattern_16x16_policy.patterns[0]),
	      "narrow-16x16 policy should match the 16x16 cross-format case");
	check(pattern_32x16_policy.pattern_count == 1u,
	      "narrow-32x16 policy should expose exactly one birth pattern");
	check(matches_hires_lookup_birth_pattern(cross_owner_32x16, pattern_32x16_policy.patterns[0]),
	      "narrow-32x16 policy should match the 32x16 cross-format case");
	check(pattern_32x32_16x16_policy.pattern_count == 2u,
	      "narrow-32x32-16x16 policy should expose exactly two birth patterns");
	check(matches_hires_lookup_birth_pattern(same_owner, pattern_32x32_16x16_policy.patterns[0]),
	      "narrow-32x32-16x16 policy should include the 32x32 same-format case");
	check(matches_hires_lookup_birth_pattern(cross_owner, pattern_32x32_16x16_policy.patterns[1]),
	      "narrow-32x32-16x16 policy should include the 16x16 cross-format case");
	check(pattern_32x32_32x16_policy.pattern_count == 2u,
	      "narrow-32x32-32x16 policy should expose exactly two birth patterns");
	check(matches_hires_lookup_birth_pattern(same_owner, pattern_32x32_32x16_policy.patterns[0]),
	      "narrow-32x32-32x16 policy should include the 32x32 same-format case");
	check(matches_hires_lookup_birth_pattern(cross_owner_32x16, pattern_32x32_32x16_policy.patterns[1]),
	      "narrow-32x32-32x16 policy should include the 32x16 cross-format case");
}
