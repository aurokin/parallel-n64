...
(bundle_dir / "bundle.json").write_text(json.dumps({
    "fixture_id": "synthetic-generic-family",
    "inputs": {
...
summary_path.write_text(json.dumps({
    "summary_title": "generic family fallback",
    "all_passed": True,
    "fixtures": [
        {"label": "generic-family", "fixture_id": "synthetic-generic-family", "bundle_dir": "../bundle", "passed": True},
    ],
}, indent=2) + "\n")
PY
