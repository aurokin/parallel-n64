...
expected_zero = {
    ...
    "package_manifest_runtime_ready_record_count": 8606,
    "package_manifest_runtime_ready_record_class": "compat-only",
    "package_manifest_runtime_ready_native_sampled_record_count": 0,
    "package_manifest_runtime_ready_compat_record_count": 8606,
    "package_manifest_runtime_deferred_record_count": 377,
    ...
    "promotion_blocker_runtime_state_counts": {"canonical-only": 377},
    "promotion_blocker_reason_counts": {"exact-family-ambiguous": 377},
...
expected_context = {
    ...
    "package_manifest_runtime_ready_record_count": 8501,
    ...
    "package_manifest_runtime_ready_compat_record_count": 8473,
    "package_manifest_runtime_deferred_record_count": 373,
    "package_manifest_runtime_deferred_record_class": "compat-only",
    "binding_count": 15,
    "unresolved_count": 13,
    ...
    "gate_success": True,
    "reused_existing": True,
    "promotion_blocker_runtime_state_counts": {"canonical-only": 373},
    "promotion_blocker_reason_counts": {"exact-family-ambiguous": 373},
    "promotion_blocker_reason_unclassified_family_count": 0,
