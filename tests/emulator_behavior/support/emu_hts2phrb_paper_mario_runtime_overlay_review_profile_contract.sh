...
expected = {
    ...
    "package_manifest_runtime_ready_record_count": 8581,
    ...
    "package_manifest_runtime_ready_compat_record_count": 8553,
    "package_manifest_runtime_deferred_record_count": 302,
    ...
    "promotion_blocker_runtime_state_counts": {"canonical-only": 302},
    "promotion_blocker_reason_counts": {"exact-family-ambiguous": 302},
    "promotion_blocker_reason_unclassified_family_count": 0,
    "unresolved_family_reason_runtime_state_counts": {
        "exact-family-ambiguous": {"canonical-only": 302, "runtime-ready-package": 4}
    },
    "unresolved_family_reason_variant_group_count_counts": {"exact-family-ambiguous": {"2": 199, "3": 46, "4": 60, "5": 1}},
    "unresolved_family_canonical_only_review_group_count": 75,
    "unresolved_family_canonical_only_family_count": 302,
    ...
    "canonical_family_selection_review_selection_count": 66,
    "canonical_family_selection_review_family_count": 66,
}
...
if report.get("canonical_family_selection_review_selection_count") != 66:
    raise SystemExit(
...
if report.get("canonical_family_selection_review_family_count") != 66:
    raise SystemExit(
