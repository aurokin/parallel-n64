...
require_pattern 'focus_retroarch_window() {' "RetroArch focus helper missing"
require_pattern 'xdotool search --onlyvisible --name "RetroArch"' "RetroArch window search missing"
