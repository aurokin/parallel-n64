...
EOF
  ...
  # input drivers ride the same condition: with the env unset the append
  # config stays byte-identical to the display-host baseline
  # (APPEND_CONFIG_SHA256). Mirrors retroarch_stdin_session.sh.
